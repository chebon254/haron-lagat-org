                ...
                <div className="container max-w-screen-xl mx-auto px-4">
                    ...
                    <div className="columns-1 md:columns-2 xl:columns-3 gap-7 ">
                        <div className=" break-inside-avoid mb-8">
                            <img className="h-auto max-w-full rounded-lg" src="/image/plan/one.jpeg" alt="Gallery image" />
                        </div>
                        <div className=" break-inside-avoid  mb-8">
                            <img className="h-auto max-w-full rounded-lg" src="/image/plan/two.jpeg" alt="Gallery image" />
                        </div>
                        <div className=" break-inside-avoid  mb-8">
                            <img className="h-auto max-w-full rounded-lg" src="/image/plan/three.jpeg" alt="Gallery image" />
                        </div>
                        <div className=" break-inside-avoid  mb-8">
                            <img className="h-auto max-w-full rounded-lg" src="/image/plan/four.jpeg" alt="Gallery image" />
                        </div>
                        <div className=" break-inside-avoid  mb-8">
                            <img className="h-auto max-w-full rounded-lg" src="/image/plan/five.jpeg" alt="Gallery image" />
                        </div>
                    </div>
                </div>
            </section>
...
export default proposedGallery