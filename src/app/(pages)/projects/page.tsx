        ...
        <>
            <section className="bg-white py-16">
                <div className="container max-w-screen-xl mx-auto px-4">
                    <h1 className="font-semibold text-gray-900 text-xl md:text-4xl text-center mb-4">Projects</h1>
                    <p className="font-light text-gray-400 text-sm md:text-md lg:text-lg text-center mb-16">Projects currently running.</p>
