...
function CommunityOutreachProgram() {
    return (
        <section className="container max-w-7xl mx-auto pb-16 px-4 sm:px-6 lg:px-8">
            ...
            {/* Image */}
            <div className="container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded" style={{ backgroundImage: "url('/image/Haron/elder group.jpeg')", height: '75vh' }}></div>
